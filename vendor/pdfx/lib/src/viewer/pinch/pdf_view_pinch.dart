    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return InteractiveViewer(
          ...
          // Upstream hardcodes scrollPans (wheel = pan), which leaves mouse
          // wheel with no way to zoom. scrollScales gives wheel = zoom while
          // drag-pan and touch-pinch-to-zoom keep working exactly as before.

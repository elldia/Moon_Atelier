...
class BookCoverReader {
  static Future<images.Image?> readBookCover(EpubBookRef bookRef) async {
    ...
    // image ^4.9.2 (bumped for pdfrx's native PDF text extraction -- see
    // pubspec.yaml) tightened decodeImage's parameter from List<int> to
    // Uint8List; readContentAsBytes() only returns the former.

...
const _dict = <String, List<String>>{
  ...
  'wifi_transfer_instructions': [
    '같은 Wi-Fi에 연결된 PC나 폰의 브라우저에서 아래 주소로 접속해 파일을 보내주세요.',
    'From a browser on a PC or phone on the same Wi-Fi, open the address below and send a file.',
    '同じWi-Fiに接続されたPCやスマホのブラウザで下のアドレスにアクセスし、ファイルを送信してください。',
    '在同一Wi-Fi下的电脑或手机浏览器中打开下面的地址并发送文件。',
  ],
